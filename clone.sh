#!/bin/bash
  ...
  #remove_HALS
   ...
   #clone_HALS
    ...
    #clone_trees
      git clone https://github.com/ancient-devices/device_xiaomi_lavender-S -b arc device/xiaomi/lavender
      git clone https://github.com/ancient-devices/android_vendor_xiaomi_lavender-S -b evo vendor/xiaomi/lavender
