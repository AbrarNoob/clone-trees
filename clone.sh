  ...
  #remove_HALS
   ...
   #clone_HALS
    ...
    #clone_trees
      ...
      git clone https://github.com/CorvusRom-Devices/vendor_xiaomi_lavender -b S vendor/xiaomi/lavender
      #git clone https://github.com/MukulSharma06175/kernel-xiaomi-lavender -b main kernel/xiaomi/lavender
